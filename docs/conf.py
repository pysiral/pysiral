...
latex_documents = [
    (master_doc, 'pysiral.tex', u'pysiral Documentation',
     u'Stefan Hendricks', 'manual'),
]
...
man_pages = [
    (master_doc, 'pysiral', u'pysiral Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pysiral', u'pysiral Documentation',
     author, 'pysiral', 'One line description of project.',
     'Miscellaneous'),
]
