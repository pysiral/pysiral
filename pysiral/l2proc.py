...
#
#            elev_points = np.where(np.isfinite(l2.elev))[0]
#            reflectivity = l1b.classifier.get_parameter("reflectivity")
#
#            print np.amax(reflectivity)
#
#            reflectivity_is_nan = np.where(np.isnan(reflectivity))[0]
#            reflectivity[reflectivity_is_nan] = -1
#
...
#            plt.scatter(x, l2.elev-l2.mss, cmap=cmap,
#                        marker="o", alpha=0.5, label="elev",
#                        c=reflectivity, vmin=0, vmax=1)
#            plt.ylim(-1, 3)
#            plt.colorbar()
#
#            plt.figure("reflectivity_profile")
#
#            plt.scatter(x, reflectivity, c=reflectivity, vmin=0, vmax=1)
#            plt.scatter(x[elev_points], reflectivity[elev_points],
#                        c=reflectivity[elev_points], vmin=0, vmax=1)

#            plt.figure("echo_peak_power")
#            echo_peak_power = l1b.classifier.get_parameter("echo_peak_power")
#            plt.scatter(x, l2.elev-l2.mss, marker="o", alpha=0.5, label="elev",
#                        c=echo_peak_power, vmin=0, vmax=1.5)
#            plt.ylim(-1, 3)
#            # plt.colorbar()
#
#            plt.figure("echo_peak_power_profile")
#            plt.scatter(x[elev_points], echo_peak_power[elev_points],
#                        c=echo_peak_power[elev_points], vmin=0, vmax=1.5)
#
#            plt.figure("echo_gain")
#            echo_gain = l1b.classifier.get_parameter("echo_gain")
#            plt.scatter(x, l2.elev-l2.mss, marker="o", alpha=0.5, label="elev",
#                        c=echo_gain)
#            plt.ylim(-1, 3)
#            plt.colorbar()
#
#            plt.figure("echo_gain_profile")
#            plt.scatter(x[elev_points], echo_gain[elev_points],
#                        c=echo_gain[elev_points])
#
#            plt.figure()
#            plt.plot(x, l2.mss, label="mss")
#            plt.plot(x, l2.mss+l2.ssa, label="mss+ssa")
