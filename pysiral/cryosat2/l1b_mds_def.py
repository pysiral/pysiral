...
class Cryosat2SARBaselineC(Cryosat2L1bMDSDefinition):
    ...
    def get_mds_parser(self):
        ...
        self.onehz_waveform_group = Padding(300)
#        self.onehz_waveform_group = Struct(
#            "avg_waveform",
#            self.mdsr_timestamp,
#            OneTenthMicroDeg(SBInt32("latitude")),
...
class Cryosat2SARBaselineCFull(Cryosat2L1bMDSDefinition):

    def __init__(self):

        super(Cryosat2SARBaselineCFull, self).__init__()
...
class Cryosat2SINBaselineB(Cryosat2L1bMDSDefinition):

    def __init__(self):

        super(Cryosat2SINBaselineB, self).__init__()
